...
;; Lower = faster indexing but less responsive Emacs
;; Higher = slower indexing but more responsive Emacs
(setq org-db-v3-index-delay 0.05)  ; default: 50ms (~20 files/sec)
